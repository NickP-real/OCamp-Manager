...
CREATE TABLE IF NOT EXISTS "camp_major" (
	...
	"camp_id" varchar(24) NOT NULL,
	"major_id" varchar(24) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "room_participant" (
	"id" varchar(24) PRIMARY KEY NOT NULL,
	"room_id" varchar(24) NOT NULL,
	"camp_participant_id" varchar(24) NOT NULL,
	"deleted_at" timestamp DEFAULT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
...
CREATE TABLE IF NOT EXISTS "room_staff" (
	"id" varchar(24) PRIMARY KEY NOT NULL,
	"room_id" varchar(24) NOT NULL,
	"camp_staff_id" varchar(24) NOT NULL,
	"deleted_at" timestamp DEFAULT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
...
CREATE INDEX IF NOT EXISTS "staff_idx_6" ON "staff" ("updated_at");